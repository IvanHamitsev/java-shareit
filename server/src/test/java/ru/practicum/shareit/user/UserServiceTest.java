...
class UserServiceTest {
    ...
    void testCreateUpdateGetDeleteUsers() {
        UserDto user1Dto = createUserDto("Имя1", "email1@yandex.ru", "login1", LocalDate.now().minusYears(20));
        UserDto user2Dto = createUserDto("Имя2", "email2@yandex.ru", "login2", LocalDate.now().minusYears(15));
        UserDto user3Dto = createUserDto("Имя3", "email3@yandex.ru", "login3", LocalDate.now().minusYears(10));
